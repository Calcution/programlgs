...
class Employee
{
	/* Task 7B: Add instance variables */
  
   
	/* Task 7C: Add three constructors */
   
   
	/* Task 7D: Add set (mutator) and get (accessor) meethods

   
	/* Task 7F: Add toString method */
   
   
	/* Task 7G: Add equals method */
			...
			switch( choice )
			{
				case 'A':
					if ( empCount < MAX_EMPLOYEES-1 )
					{
						...
						// Task 7E: Prompt for user information and set the object 
